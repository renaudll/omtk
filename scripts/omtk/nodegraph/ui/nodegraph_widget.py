...
# Form implementation generated from reading ui file '/home/rll/dev/python/omtk/python/omtk/nodegraph/ui/nodegraph_widget.ui'
#
# Created: Fri Oct  5 22:05:38 2018
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.widget_toolbar.setWindowTitle(
            QtWidgets.QApplication.translate("MainWindow", "toolBar_2", None, -1)
        )
        self.toolBar_arrange.setWindowTitle(
            QtWidgets.QApplication.translate("MainWindow", "toolBar_2", None, -1)
        )
        ...
        self.actionExpand.setText(
            QtWidgets.QApplication.translate("MainWindow", "Expand", None, -1)
        )
        self.actionCollapse.setText(
            QtWidgets.QApplication.translate("MainWindow", "Collapse", None, -1)
        )
        self.actionGoDown.setText(
            QtWidgets.QApplication.translate("MainWindow", "Go Down", None, -1)
        )
        ...
        self.actionUngroup.setText(
            QtWidgets.QApplication.translate("MainWindow", "Ungroup", None, -1)
        )
        self.actionMatchMayaEditorPositions.setText(
            QtWidgets.QApplication.translate("MainWindow", "&Sync to Maya Node Editor", None, -1)
        )
        self.actionMatchMayaEditorPositions.setToolTip(
            QtWidgets.QApplication.translate("MainWindow", "Sync with Maya", None, -1)
        )
        self.actionLayoutUpstream.setText(
            QtWidgets.QApplication.translate("MainWindow", "&Layout Upstream", None, -1)
        )
        self.actionLayoutDownstream.setText(
            QtWidgets.QApplication.translate("MainWindow", "Layout &Downstream", None, -1)
        )
        self.actionLayoutSpring.setText(
            QtWidgets.QApplication.translate("MainWindow", "La&yout Spring", None, -1)
        )
        self.actionLayoutRecenter.setText(
            QtWidgets.QApplication.translate("MainWindow", "Recenter", None, -1)
        )
        self.actionExpandMore.setText(
            QtWidgets.QApplication.translate("MainWindow", "Expand 2x", None, -1)
        )
        self.actionExpandMoreMore.setText(
            QtWidgets.QApplication.translate("MainWindow", "Expand 3x", None, -1)
        )
        self.actionFrameAll.setText(
            QtWidgets.QApplication.translate("MainWindow", "Frame All", None, -1)
        )
        self.actionFrameSelected.setText(
            QtWidgets.QApplication.translate("MainWindow", "Frame Selected", None, -1)
        )


from omtk.qt_widgets.widget_toolbar import WidgetToolbar
