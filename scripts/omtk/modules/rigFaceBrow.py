...
class FaceBrow(rigFaceAvarGrps.AvarGrpAreaOnSurface):
    ...
    def _build_avar_macro_l(self, rig, jnt_tm=None, ctrl_tm=None, **kwargs):
        ...
        super(FaceBrow, self)._build_avar_macro_l(rig, jnt_tm=jnt_tm, ctrl_tm=jnt_tm, **kwargs)


    def _build_avar_macro_r(self, rig, jnt_tm=None, ctrl_tm=None, **kwargs):# Create right avar if necessary
        ...
        super(FaceBrow, self)._build_avar_macro_r(rig, jnt_tm=jnt_tm, ctrl_tm=jnt_tm, **kwargs)
