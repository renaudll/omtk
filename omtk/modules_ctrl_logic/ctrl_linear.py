...
class BaseCalibratableCtrlModel(classModuleCtrlLogic.BaseCtrlModel):
    name = 'Linear'
...
class CtrlLogicLinear(BaseCalibratableCtrlModel):
    """
    ...
    def build(self, avar, ref=None, ref_tm=None, grp_rig=None, obj_mesh=None, u_coord=None, v_coord=None,
        ...
        super(CtrlLogicLinear, self).build(avar, **kwargs)
    ...
    def unbuild(self):
        super(CtrlLogicLinear, self).unbuild()
