...
class ComponentLimb(ComponentScripted):
    need_grp_dag = True
    component_name = 'Limb'
    component_id = constants.BuiltInComponentIds.Limb

    def __init__(self, **kwargs):
        super(ComponentLimb, self).__init__(**kwargs)
    ...
    def _create_io(self):
        self.add_input_attr('bindPoses', [pymel.datatypes.Matrix()] * 3)
        self.add_input_attr('hook', pymel.datatypes.Matrix())
        self.add_input_attr('')
