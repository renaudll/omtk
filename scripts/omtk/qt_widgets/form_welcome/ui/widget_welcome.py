...
# Form implementation generated from reading ui file '/home/rll/dev/python/omtk/python/omtk/qt_widgets/form_welcome/ui/widget_welcome.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        spacerItem2 = QtWidgets.QSpacerItem(
            17, 78, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding
        )
        self.verticalLayout_3.addItem(spacerItem2)
        self.horizontalLayout.addLayout(self.verticalLayout_3)
        self.verticalLayout_4.addLayout(self.horizontalLayout)
        self.cb_show_at_startup = QtWidgets.QCheckBox(Form)
        self.cb_show_at_startup.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.cb_show_at_startup.setObjectName("cb_show_at_startup")
        self.verticalLayout_4.addWidget(self.cb_show_at_startup)
    ...
    def retranslateUi(self, Form):
        ...
        self.btn_create_rig_default.setText(
            QtWidgets.QApplication.translate("Form", "Start from a rig", None, -1)
        )
        self.label_3.setText(QtWidgets.QApplication.translate("Form", "Available rigs:", None, -1))
        self.btn_create_rig_template.setText(
            QtWidgets.QApplication.translate("Form", "Start from a template", None, -1)
        )
        self.label_4.setText(
            QtWidgets.QApplication.translate("Form", "Available templates", None, -1)
        )
        self.btn_start.setText(
            QtWidgets.QApplication.translate("Form", "Start from scratch", None, -1)
        )
        self.cb_show_at_startup.setText(
            QtWidgets.QApplication.translate("Form", "Show at startup", None, -1)
        )
