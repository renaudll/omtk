...
class Leg(Arm):
    ...
    def create_footroll(self):
        ...
        oPivotM = RigNode(name=self._namemap_rig.Serialize('pivotM'))
        oPivotM.build()
        oPivotM.t.set(p3Toes)  # Optimisation: t.set is faster than setMatrix
        # oPivotM.setMatrix(tmToes)
        # oPivotM.r.set((0,0,0))

        oPivotF = RigNode(name=self._namemap_rig.Serialize('pivotF'))
        oPivotF.build()
        ...
        oPivotB = RigNode(name=self._namemap_rig.Serialize('pivotB'))
        oPivotB.build()
        ...
        oFootRollRoot = RigNode(name=self._namemap_rig.Serialize('footroll'))
        oFootRollRoot.build()
        ...
        oIkHandleFoot.rename(self._namemap_rig.Serialize('ikHandle', 'foot'))
        ...
        oIkHandleToes.rename(self._namemap_rig.Serialize('ikHandle', 'ties'))
