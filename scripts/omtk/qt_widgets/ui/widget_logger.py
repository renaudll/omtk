...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox_log_level.setItemText(
            0, QtWidgets.QApplication.translate("Form", "Error", None, -1)
        )
        self.comboBox_log_level.setItemText(
            1, QtWidgets.QApplication.translate("Form", "Warning", None, -1)
        )
        self.comboBox_log_level.setItemText(
            2, QtWidgets.QApplication.translate("Form", "Info", None, -1)
        )
        self.comboBox_log_level.setItemText(
            3, QtWidgets.QApplication.translate("Form", "Debug", None, -1)
        )
        self.pushButton_logs_save.setText(
            QtWidgets.QApplication.translate("Form", "Save", None, -1)
        )
        self.pushButton_logs_clear.setText(
            QtWidgets.QApplication.translate("Form", "Clear", None, -1)
        )
