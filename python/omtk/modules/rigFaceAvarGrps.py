...
from omtk.core.entity_attribute import EntityPymelAttributeCollection
...
class AvarGrp(module.Module):  # todo: why do we inherit from Avar exactly? Is inheriting from module more logical?
    """
