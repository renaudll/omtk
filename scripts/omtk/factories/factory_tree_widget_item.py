...
class TreeWidgetItemRig(TreeWidgetItemComponent):
    def __init__(self, parent, meta_data):
        super(TreeWidgetItemRig, self).__init__(
            parent, factory_datatypes.AttributeType.Rig, meta_data
        )
...
class TreeWidgetItemModule(TreeWidgetItemComponent):
    def __init__(self, parent, meta_data):
        super(TreeWidgetItemModule, self).__init__(
            parent, factory_datatypes.AttributeType.Module, meta_data
        )
...
def get(value, known_data_id=None):
    ...
    if value_type in (AttributeType.Component, AttributeType.Module, AttributeType.Rig):
