...
class SplitterNode(Node):
    ...
    def build(self, nomenclature_rig, **kwargs):
        ...
        #
        attr_inn = libAttr.addAttr(
            grp_splitter_inn, longName="inn", attributeType="message"
        )
        attr_out = libAttr.addAttr(
            grp_splitter_out, longName="out", attributeType="message"
        )
        ...
        attr_jaw_ratio_out_raw = libRigging.create_utility_node(
            ...
            input1D=(self.attr_inn_jaw_default_ratio, attr_jaw_ratio_cancelation),
        ).output1D
...
class AvarSurfaceLipModel(model_avar_surface.AvarSurfaceModel):
    ...
    def _get_follicle_relative_uv_attr(self, **kwargs):
        ...
        splitter.build(nomenclature_rig, name=nomenclature_rig.resolve("splitter"))
        ...
        pymel.connectAttr(
            self._attr_inn_jaw_ratio_default, splitter.attr_inn_jaw_default_ratio
        )
