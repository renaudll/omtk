...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(
            QtWidgets.QApplication.translate("MainWindow", "Open Rigging Toolkit", None, -1)
        )
        self.actionUpdate.setText(
            QtWidgets.QApplication.translate("MainWindow", "&Update All", None, -1)
        )
        self.actionUpdate.setToolTip(
            QtWidgets.QApplication.translate("MainWindow", "Update", None, -1)
        )
        ...
        self.actionBuildAll.setText(
            QtWidgets.QApplication.translate("MainWindow", "&Build All", None, -1)
        )
        self.actionUnbuildAll.setText(
            QtWidgets.QApplication.translate("MainWindow", "&Unbuild All", None, -1)
        )
        self.actionRebuildAll.setText(
            QtWidgets.QApplication.translate("MainWindow", "&Rebuild All", None, -1)
        )
        self.actionCreateModule.setText(
            QtWidgets.QApplication.translate("MainWindow", "&Create Module", None, -1)
        )
        self.actionAddNodeToModule.setText(
            QtWidgets.QApplication.translate("MainWindow", "&Add Selection", None, -1)
        )
        ...
        self.actionMirrorJntsLToR.setText(
            QtWidgets.QApplication.translate("MainWindow", "&Mirror L -> R", None, -1)
        )
        self.actionMirrorJntsRToL.setText(
            QtWidgets.QApplication.translate("MainWindow", "Mirror &R -> L", None, -1)
        )
        self.actionMirrorSelection.setText(
            QtWidgets.QApplication.translate("MainWindow", "Mirror &using Selection", None, -1)
        )
        self.actionShowPluginManager.setText(
            QtWidgets.QApplication.translate("MainWindow", "Plugin &Manager", None, -1)
        )
        ...
        self.actionCreateComponent.setText(
            QtWidgets.QApplication.translate("MainWindow", "&Create New", None, -1)
        )
