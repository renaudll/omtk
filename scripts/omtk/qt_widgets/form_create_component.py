...
class CreateComponentForm(main_window_extended.MainWindowExtended):
    ...
    def set_wizard(self, wizard, wizard_network=None):
        ...
        self.ui.widget_view_ctrl.set_entries(
            wizard, libComponent.ComponentPartCtrl, wizard.parts_ctrl
        )
        self.ui.widget_view_infl.set_entries(
            wizard, libComponent.ComponentPartInfluence, wizard.parts_influences
        )
        self.ui.widget_view_guid.set_entries(
            wizard, libComponent.ComponentPartGuide, wizard.parts_guides
        )
    ...
    def update_enabled(self):
        ...
        self.ui.pushButton_submit.setEnabled(
            have_component and have_name and have_author and have_version and have_uid
        )
    ...
    def on_select(self):
        ...
        if grp_dag and grp_inn.exists():
            ...
            objs_to_select.extend(pymel.listRelatives(grp_dag, allDescendents=True))
