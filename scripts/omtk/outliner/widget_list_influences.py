...
import omtk.core.constants_ui
from omtk import decorators
from omtk.libs import libQt
from omtk.outliner.ui import widget_list_influences
...
class WidgetListInfluences(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Tweak _gui
        self.ui.treeWidget.setStyleSheet(omtk.core.constants_ui._STYLE_SHEET)
    ...
    def _fill_widget_influences(self, qt_parent, data):
        ...
        if obj:
            ...
            if self._is_influence(obj):  # todo: listen to the Rig class
                ...
                omtk.constants_ui._set_icon_from_type(obj, item)
