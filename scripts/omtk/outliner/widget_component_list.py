...
from omtk.outliner.ui import widget_list_componentdef
from omtk.vendor.Qt import QtWidgets, QtCore
from omtk.vendor.omtk_compound import Compound, CompoundDefinition, Registry
...
class MayaNodeDefinition(CompoundDefinition):
    type = "Maya Node"
...
class ComponentDefinitionTableModel(QtCore.QAbstractTableModel):
    _HEADERS = ("Name", "Version", "Type", "Description")
...
class WidgetComponentList(QtWidgets.QWidget):
    signalComponentCreated = QtCore.Signal(Compound)
    ...
    def action_submit(self):
        ...
        for entry in entries:
            if isinstance(entry, CompoundDefinition):
