...
class Ui_OpenRiggingToolkit(object):
    ...
    def retranslateUi(self, OpenRiggingToolkit):
        OpenRiggingToolkit.setWindowTitle(QtWidgets.QApplication.translate("OpenRiggingToolkit", "Open Rigging Toolkit"))
        self.menuFile.setTitle(QtWidgets.QApplication.translate("OpenRiggingToolkit", "Fi&le"))
        self.menuRig.setTitle(QtWidgets.QApplication.translate("OpenRiggingToolkit", "Ri&g"))
        self.menuJoint.setTitle(QtWidgets.QApplication.translate("OpenRiggingToolkit", "Mo&dules"))
        self.menuInfluences.setTitle(QtWidgets.QApplication.translate("OpenRiggingToolkit", "I&nfluences"))
        self.menuSettings.setTitle(QtWidgets.QApplication.translate("OpenRiggingToolkit", "Settings"))
        self.menuComponents.setTitle(QtWidgets.QApplication.translate("OpenRiggingToolkit", "&Components"))
        self.dockWidget_modules.setWindowTitle(QtWidgets.QApplication.translate("OpenRiggingToolkit", "&Modules"))
        self.dockWidget_influences.setWindowTitle(QtWidgets.QApplication.translate("OpenRiggingToolkit", "Infl&uences"))
        self.dockWidget_meshes.setWindowTitle(QtWidgets.QApplication.translate("OpenRiggingToolkit", "Meshes"))
        self.actionUpdate.setText(QtWidgets.QApplication.translate("OpenRiggingToolkit", "&Update All"))
        self.actionUpdate.setToolTip(QtWidgets.QApplication.translate("OpenRiggingToolkit", "Update"))
        self.actionImport.setText(QtWidgets.QApplication.translate("OpenRiggingToolkit", "&Import"))
        self.actionExport.setText(QtWidgets.QApplication.translate("OpenRiggingToolkit", "&Export"))
        self.actionBuildAll.setText(QtWidgets.QApplication.translate("OpenRiggingToolkit", "&Build All"))
        self.actionUnbuildAll.setText(QtWidgets.QApplication.translate("OpenRiggingToolkit", "&Unbuild All"))
        self.actionRebuildAll.setText(QtWidgets.QApplication.translate("OpenRiggingToolkit", "&Rebuild All"))
        self.actionCreateModule.setText(QtWidgets.QApplication.translate("OpenRiggingToolkit", "&Create Module"))
        self.actionAddNodeToModule.setText(QtWidgets.QApplication.translate("OpenRiggingToolkit", "&Add Selection"))
        self.actionRemoveNodeFromModule.setText(QtWidgets.QApplication.translate("OpenRiggingToolkit", "&Remove Selection"))
        self.actionMirrorJntsLToR.setText(QtWidgets.QApplication.translate("OpenRiggingToolkit", "&Mirror L -> R"))
        self.actionMirrorJntsRToL.setText(QtWidgets.QApplication.translate("OpenRiggingToolkit", "Mirror &R -> L"))
        self.actionMirrorSelection.setText(QtWidgets.QApplication.translate("OpenRiggingToolkit", "Mirror &using Selection"))
        self.actionShowPluginManager.setText(QtWidgets.QApplication.translate("OpenRiggingToolkit", "Plugin &Manager"))
