...
class NodeGraphWidget(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.ui.actionMatchMayaEditorPositions.triggered.connect(
            self.on_match_maya_editor_positions
        )
        ...
        self._create_shortcut(
            QtCore.Qt.ControlModifier + QtCore.Qt.Key_D, self.on_shortcut_duplicate
        )
        ...
        # todo: move elsewhere?
        self._create_shortcut(
            QtCore.Qt.Key_T, self.ui.widget_toolbar.create_favorite_callback("transform")
        )
    ...
    def create_tab(self):
        ...
        ctrl = controller.NodeGraphController(
            registry=registry, model=self._subgraph_proxy_model, view=view
        )
        self.add_view(view)
